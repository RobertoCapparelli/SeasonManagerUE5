...
struct Z_Construct_UEnum_SeasonManager_ESeasonBlendType_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "EaseIn.Name", "ESeasonBlendType::EaseIn" },
		{ "EaseInOut.DisplayName", "Ease In/Out" },
		{ "EaseInOut.Name", "ESeasonBlendType::EaseInOut" },
		{ "EaseOut.DisplayName", "Ease Out" },
		{ "EaseOut.Name", "ESeasonBlendType::EaseOut" },
		{ "Linear.DisplayName", "Linear" },
		{ "Linear.Name", "ESeasonBlendType::Linear" },
		{ "ModuleRelativePath", "Public/Utility/SeasonBlendTypes.h" },
		{ "Step.DisplayName", "Step" },
		{ "Step.Name", "ESeasonBlendType::Step" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "ESeasonBlendType::Linear", (int64)ESeasonBlendType::Linear },
		{ "ESeasonBlendType::EaseIn", (int64)ESeasonBlendType::EaseIn },
		{ "ESeasonBlendType::EaseOut", (int64)ESeasonBlendType::EaseOut },
		{ "ESeasonBlendType::EaseInOut", (int64)ESeasonBlendType::EaseInOut },
		{ "ESeasonBlendType::Step", (int64)ESeasonBlendType::Step },
	};
...
struct Z_CompiledInDeferFile_FID_Users_39345_Desktop_Progetti_Unreal_MotherNaturePack_Plugins_SeasonManager_Source_SeasonManager_Public_Utility_SeasonBlendTypes_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESeasonBlendType_StaticEnum, TEXT("ESeasonBlendType"), &Z_Registration_Info_UEnum_ESeasonBlendType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1275642667U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_39345_Desktop_Progetti_Unreal_MotherNaturePack_Plugins_SeasonManager_Source_SeasonManager_Public_Utility_SeasonBlendTypes_h_2526547421(TEXT("/Script/SeasonManager"),
	nullptr, 0,
	nullptr, 0,
